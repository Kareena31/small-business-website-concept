...
async function initialize() {
  ...
  if (config.demo_mode) {
    ...
    inquiries = [
      ...
      {id:102,created_at:1789192800,name:"Sample Customer B",email:"sample-b@example.com",phone:"",vehicle:"2021 Sample Vehicle",service:"Maintenance question",message:"Fictional preview: I would like to ask about routine maintenance next week.",status:"contacted"},
