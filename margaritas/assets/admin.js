  ...
  inquiries.forEach(item => {
    ...
    select.addEventListener("change", async () => {
      ...
      try {
        ...
        render();
        notify(config.demo_mode ? "Preview updated. No customer was contacted and nothing was saved." : "Request status saved. Contact the customer separately to confirm any reservation.");
...
async function initialize() {
  ...
  if (config.demo_mode) {
    ...
    inquiries = [
      {id:103,created_at:1789198200,name:"Sample Customer A",email:"sample-a@example.com",phone:"",visit_details:"Sample group of 4",service:"Visit or group question",message:"Fictional preview: Could you advise on a visit for a small group?",status:"new"},
      {id:102,created_at:1789192800,name:"Sample Customer B",email:"sample-b@example.com",phone:"",visit_details:"Sample takeaway question",service:"Menu or takeaway question",message:"Fictional preview: Could you confirm the current takeaway options?",status:"contacted"},
      {id:101,created_at:1789117200,name:"Sample Customer C",email:"sample-c@example.com",phone:"",visit_details:"",service:"Something else",message:"Fictional preview: Thank you for calling. We agreed to a visit on Tuesday.",status:"scheduled"}
    ];
    await showDashboard();
  } else {
