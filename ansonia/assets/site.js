...
document.querySelector("#sample-button").addEventListener("click", () => {
  ...
  form.elements.vehicle.value = "2019 Sample Vehicle";
  form.elements.email.value = "sample@example.com";
  form.elements.phone.value = "";
  form.elements.service.value = "Repair inquiry";
  form.elements.message.value = "This is a fictional sample inquiry. I would like to ask about an appointment next week.";
